...
> ANSWER: In "MAC[B-Z]", the code is searching for any line that contains "MAC" followed by any capital letter of the alphabet that is not "A". "MAC[B|Z]" is now searching for any line that contains "MAC" followed by a capital "B" or "Z". Then "^MAC[B-Z]" specifically looks for lines that start with "MAC" followed directly by any capital letter that is not "A".
