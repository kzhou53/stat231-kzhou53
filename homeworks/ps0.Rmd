...
dino_data %>%
  summarize(r = cor(x, y))
```
The correlation coefficient for the star dataset between x and y is the same as the dino dataset correlation coefficient: -.064.
...
dino_data %>%
  summarize(r = cor(x, y))
```
As with the previous two datasets, the correlation coefficient is the same for this data set.
