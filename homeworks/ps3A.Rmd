...
> ANSWER: Since rnorm gives us random values, how could we go about specifying an explicit set of numbers and then perhaps choosing randomly from that set. Also where does rnorm pull these numbers from? A second question is: why does our code to display summary statistics not need a reactive rv in server? 
