...
library(tidyverse)
ggplot(data = mpg) + 
  geom_point(mapping = aes(color = "blue", x = displ, y = hwy)) +
...
ggplot(data = mlb_teams, aes(x= log_payroll, y= WPct)) + 
  ...
  geom_smooth()
```
The graphic I created demonstrates that there is a loose, direct correlation between the payroll and winning percentage. That is, the more a team pays its players, the larger their winning percentage is, ie, the more games they win (per season?).
