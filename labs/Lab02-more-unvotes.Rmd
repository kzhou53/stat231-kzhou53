...
```
Using teh exact smae process as the previous question but with lty instead of shape, we can give each country a different line type and clean up the legend.
